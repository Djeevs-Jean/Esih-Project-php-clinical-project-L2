                    ...
                    <ul class="navbar-nav ms-auto  mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownBlog">
                                ...
                                <li><a class="dropdown-item" href="/src/lists_medecin.php">List Medecin</a></li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownBlog">
                                <li><a class="dropdown-item" href="/src/patient.php">Pages Patient</a></li>
                                <li><a class="dropdown-item" href="/src/patient.php">Pages Patient</a></li>
                            </ul>
                        </li>

                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" id="navbarDropdownBlog" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Prescription</a>
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownBlog">
                                <li><a class="dropdown-item" href="/src/patient.php">Pages Patient</a></li>
                                <li><a class="dropdown-item" href="/src/patient.php">Pages Patient</a></li>
                            </ul>
