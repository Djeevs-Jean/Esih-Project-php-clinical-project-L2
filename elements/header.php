    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container px-5">
                <a class="navbar-brand" href="../src/homepage.php">Hospital Djeevs</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto  mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownBlog">
                                <li><a class="dropdown-item" href="../src/prescription.php">Create Prescription</a></li>
                            </ul>
                        </li>

                        <li class="nav-item"><a class="nav-link" href="../src/liste_consultaion_prescription.php">Services</a></li>
